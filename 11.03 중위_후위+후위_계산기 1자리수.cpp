...
void print_token(precedence item); //토큰출력함수
void add_token(int* top, precedence item); //토큰추가함수
precedence delete_token(int* top); //토큰삭제함수

int getop(char[]);//계산함수1 getop
void push(double);//계산함수2 push
double pop(void); //계산함수3 pop
